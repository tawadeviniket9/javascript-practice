...
function renderTask(){
  ...
  function render(){
    ...
    tasks.forEach(task =>{
      ...
      const checkbox = taskTemplate.getElementsByClassName('checkbox');
      const tLabel = taskTemplate.getElementsByClassName('task-name')
      const gLabel = taskTemplate.getElementsByClassName('goal-name')
      checkbox.id = task.id;
      checkbox.checked = task.complete;
      taskElement.appendChild(tLabel);
      tLabel.appendChild(gLabel);
      gLabel.appendChild(checkbox);
      ...
      goalTaskLabel.innerText = 'Goal : ';
      taskElement.innerText = task.name;
      goalTask.innerText = task.goal + " hrs";
  ...
  function createTask(){
    return {id:Date.now.toString(),name:taskName, goal:taskGoal}
  }
